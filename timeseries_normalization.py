...
df = pd.read_csv("/Users/aleg2/Desktop/ydata-labeled-time-series-anomalies-v1_0/yahoo_complete_concat.csv")
...
df.to_csv('normalized_yahoo_complete.csv', index=False)
